...
@section('content')
 ...
 <div class="x_content">
                    ...
                    <div class="row">
                    <a href="{{route('productimage.create')}}" type="button" class="btn btn-info" style="float: right;">Add Product</a>
                      <div class="col-sm-6">
                      ...
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Image Title
                          </th>

                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Image 
                          </th>
                      ...
                      <tbody> 
                       @foreach($product_img as $procat)
                          <tr role="row">
                         <td>{{$procat->product->product_name}}</td>
                          <td>{{$procat->image_title}}</td>
                          <td><img src= "{{asset('/images/'.$procat->image)}}" class="img-responsive" width='50px'
                            height="50px"></td>
                          <td>{{$procat->status}}</td>
                          <td>
