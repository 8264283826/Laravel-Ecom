...
@section('content')
 ...
 <div class="x_content">
                    ...
                    <div class="row">
                    <a href="{{route('productcategory.create')}}" type="button" class="btn btn-info" style="float: right;">Add Category</a>
                      <div class="col-sm-6">
                      ...
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">slug
                          </th>
                      ...
                      <tbody> 
                       @foreach($productcategory as $procat)
                          ...
                          <td>
                            ...
                            <a class="btn btn-app" href="{{route('productcategory.edit',$procat->id)}}" style="color: red">
                            ...
                            @csrf
                          <button class="btn btn-app" href = "{{route('productcategory.destroy',$procat->id)}}"style="color: red">
                            @method('DELETE')
