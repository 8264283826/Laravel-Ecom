...
@section('content')
   ...
   <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('contactform.store')}}" method="post">
        @csrf
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Message <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="message_form" name='message_form' required="required" class="form-control col-md-7 col-xs-12">
                          </textarea>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">Email<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
