...
@section('content')
 ...
 <div class="x_content">
                    ...
                    <div class="row">
                    <a href="{{route('customerdetail.create')}}" type="button" class="btn btn-info" style="float: right;">Add Customer</a>
                      <div class="col-sm-6">
                      ...
                      <thead>
                        <tr role="row">
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">First Name
                          </th>
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Last Name
                          </th>
                           
                          <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Address
                          </th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Country 
                          </th>
                      ...
                      <tbody> 
                       @foreach($customerDetail as $procat)
                          ...
                          <td>{{$procat->email}}</td>
                          <td>{{$procat->country}}</td>


                          <td>
                           
                           <form  method = 'POST' action="{{route('customerdetail.destroy',$procat->id)}}">
                            <a class="btn btn-app" href="{{route('customerdetail.edit',$procat->id)}}" style="color: red">
                            ...
                            @csrf
                          <button class="btn btn-app" href = "{{route('customerdetail.edit',$procat->id)}}"style="color: red">
                            @method('DELETE')
