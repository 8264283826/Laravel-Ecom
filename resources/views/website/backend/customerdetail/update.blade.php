...
@section('content')
   ...
   <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
    action= "{{route('customerdetail.update',$customerdetail->id) }}"
    method="POST">
   @method('PUT')
        @csrf
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="f_name" name='f_name' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->f_name}}">
                        </div>
                      </div>
                         <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="l_name" name='l_name' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->l_name}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="companie_name" name='companie_name' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->companie_name}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="phone" name='phone' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->phone}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" name='email' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->email}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="country" name='country' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->country}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="town" name='town' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->town}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="district" name='district' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->district}}">
                        </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="post_code" name='post_code' required="required" class="form-control col-md-7 col-xs-12" value="{{$customerdetail->post_code}}">
                        </div>
                          </div>
