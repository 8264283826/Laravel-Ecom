...
@section('content')
   ...
   "{{route('product.update',$product->id) }}" method="POST">
   @method('PUT')
        @csrf
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product_name" name='product_name' required="required" value="{{$product->product_name}}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                         <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="description" name='product_desc' required="required" class="form-control col-md-7 col-xs-12">{{$product->product_desc}}
                          </textarea>
                        </div>
                      </div>
