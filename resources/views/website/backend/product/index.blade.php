...
@section('content')
 ...
 <div class="x_content">
                    ...
                    <div class="row">
                    <a href="{{route('product.create')}}" type="button" class="btn btn-info" style="float: right;">Add Product</a>
                      <div class="col-sm-6">
                      ...
                      <thead>
                        <tr role="row">
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Product Category
                          </th>
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Product Name
                          </th>
                           
                          <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Price
                          </th>
                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Status
                          </th>
                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Product Description
                          </th>
                       ...
                       @foreach($product as $procat)
                          ...
                          <td>
                           ...
                           <form  method = 'POST' action="{{route('product.destroy',$procat->id)}}">
                            <a class="btn btn-app" href="{{route('product.edit',$procat->id)}}" style="color: red">
                            ...
                            @csrf
                          <button class="btn btn-app" href = "{{route('product.destroy',$procat->id)}}"style="color: red">
                            @method('DELETE')
