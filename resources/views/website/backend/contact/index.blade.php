...
@section('content')
 ...
 <div class="x_content">
                    ...
                    <div class="row">
                    <a href="{{route('contact.create')}}" type="button" class="btn btn-info" style="float: right;">Contact Create</a>
                      <div class="col-sm-6">
                      ...
                      <thead>
                        <tr role="row">
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Location
                          </th>
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Email
                          </th>
                          ...
                          <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Address
                            ...
                            <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Phone
                          </th>
                       ...
                       @foreach($contact as $procat)
                          ...
                          <td>
                           ...
                           <form  method = 'POST' action="{{route('contact.destroy',$procat->id)}}">
                            <a class="btn btn-app" href="{{route('contact.edit',$procat->id)}}" style="color: red">
                            ...
                            @csrf
                          <button class="btn btn-app" href = "{{route('contact.destroy',$procat->id)}}"style="color: red">
                            @method('DELETE')
