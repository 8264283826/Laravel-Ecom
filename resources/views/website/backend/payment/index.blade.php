...
@section('content')
 ...
 <div class="x_content">
                    ...
                    <div class="row">
                    <a href="{{route('payment.create')}}" type="button" class="btn btn-info" style="float: right;">Add payment</a>
                      <div class="col-sm-6">
                      ...
                      <thead>
                        <tr role="row">
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Customer Name
                          </th>
                          <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Payment Type
                          </th>
                          <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 71px;" aria-sort="ascending" aria-label="First name: activate to sort column descending">Status
                          </th>
                           
                          <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 70px;" aria-label="Last name: activate to sort column ascending">Total
                          </th>
                      ...
                      <tbody> 
                       @foreach($payment as $procat)
                          <tr role="row">
                          <td >{{$procat->customerDetail->f_name.' '.$procat->customerDetail->l_name}}</td>
                          ...
                          <td>
                           ...
                           <form  method = 'POST' action="{{route('payment.index',$procat->id)}}">
                            <a class="btn btn-app" href="{{route('payment.edit',$procat->id)}}" style="color: red">
                            ...
                            @csrf
                          <button class="btn btn-app" href = "{{route('payment.destroy',$procat->id)}}"style="color: red">
                            @method('DELETE')
